...
\tagline{Telecommunication \& firmware engineer}
...
\begin{itemize}
  \item Software development in C under the \textbf{DO-178} standard and Python scripting.
  \item Use of RTOS such as PikeOS and VxWorks.
  \item Involved in design, development, QA, and testing activities.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Hardware development} (analog, digital, requirements, design, development, market launch of several devices. Schematic capture, PCB design, testing, HW review. Integration of PCBs into mechanical designs.
    \item \textbf{PCB assembly:} manual soldering TH, SMD (0402).
    \item \textbf{Firmware development} for embedded systems (mainly for nRF52, \textbf{Bluetooth 5.0 Mesh} communications).
...
\cvtag{Serial comms (I2C, SPI, UART, RS232, RS485)}
\cvtag{WiFi}
\cvtag{BLE}
\cvtag{LoRa}
\cvtag{NFC}
...
\cvtag{Web development (Django, FastAPI)}
\cvtag{LVGL}
