...
\cvevent{Desarrollador Hardware y Firmware}{TycheTools}{Feb 2020 -- actualidad}{Madrid, ES}
...
\cvevent{Prácticas de investigación electrónica}{GreenLSI (Departamento de Ingeniería Electrónica, ETSIT)}{Sept 2019 -- Feb 2020}{Madrid, ES}
\begin{itemize}
...
\cvtag{\simpleicon{makefile} Makefile}
...
\cvtag{Django}
\cvtag{FastAPI}
\cvtag{\simpleicon{lvgl} LVGL}
\cvtag{\simpleicon{flutter} Flutter}
\cvtag{\simpleicon{raspberrypi} Raspberrys}

\cvtag{Sistemas de medición de potencia trifásica}

\cvtag{\simpleicon{jira} Jira}
\cvtag{Desarrollo de producto}
